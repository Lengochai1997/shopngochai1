    ...
    <div class="c-layout-page content-dark">
        <div class="c-layout-page">
            ...
            <div class="c-layout-page" style="margin-top: 20px;">
                <div class="container">
                    @include('user.partials.sidebar', ['active' => 11])
                    <div class="c-layout-sidebar-content ">
                        <!-- BEGIN: PAGE CONTENT -->
                        <!-- BEGIN: CONTENT/SHOPS/SHOP-CUSTOMER-DASHBOARD-1 -->
                        <div class="c-content-title-1">
                            <h3 class="c-font-uppercase c-font-bold" style="margin: 0px;">Rút Quân huy</h3>
                            <p style="margin: 5px 0px;font-size: 19px;font-weight: bold;">Bạn hiện có <span style="color: red;">{{ $wallet ? number_format($wallet->quanhuy) : 0 }}</span> Quân huy.</p>
                            <div class="c-line-left"></div>
                        </div>
                        <form id="charge" method="POST" action="{{ asset('wallet/without-quanhuy') }}" class="form-horizontal form-charge">
                            @csrf
                            @method('post')
                            <div class="form-group">
                                <label for="value" class="col-md-3 control-label">Số Quân huy rút:</label>
                                <div class="col-md-6">
                                    <select class="form-control c-square c-theme" id="value" name="value">
                                        <option value="16">16 Quân huy</option>
                                        <option value="32">32 Quân huy</option>
                            ...
                            <div class="form-group">
                                <label for="username" class="col-md-3 control-label">Tài khoản nhận quân huy:</label>
                                <div class="col-md-6">
                                    <input class="form-control c-square c-theme" type="text" id="username" name="username">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="password" class="col-md-3 control-label">Mật khẩu:</label>
                                <div class="col-md-6">
                                    <input class="form-control c-square c-theme" type="password" id="password" name="password">
                                </div>
                            </div>
                            <div class="form-group c-margin-t-40">
                                <div class="col-md-offset-3 col-md-6">
                                    <button type="submit" class="btn btn-submit c-theme-btn c-btn-square c-btn-uppercase c-btn-bold btn-block" data-loading-text="<i class='fa fa-spinner fa-spin'></i>">Rút Quân huy
                                    </button>
                                </div>
                            </div>
                        </form>
                        <script type="text/javascript">
                            $(document).ready(function () {
                                $('#charge').validate({
                                    ...
                                    messages: {
                                        value: {
                                            required: 'Số quân huy chưa được chọn.',
                                            min: 'Số quân huy phải lớn hơn 0.'
                                        },
                                        username: {
                        ...
                        <script type="text/javascript">
                            ...
                            $(document).ready(function () {
                                tbListCharge = $('#list-charge').DataTable({
                                    ...
                                    "sDom": 'R<>rt<ip><"clear">',
                                    "bServerSide": true,
                                    "sAjaxSource": '{!! asset('wallet/list?type=quanhuy') !!}',
