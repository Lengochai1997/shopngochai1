    ...
    <div class="c-layout-page content-dark">
        <div class="c-layout-page">
            ...
            <div class="c-layout-page" style="margin-top: 20px;">
                <div class="container">
                    @include('user.partials.sidebar', ['active' => 12])
                    <div class="c-layout-sidebar-content">
                        <div class="c-content-title-1">
                            <h3 class="c-font-uppercase c-font-bold">Hòm quà đã mở</h3>
                        ...
                        <script type="text/javascript">
                            ...
                            $(document).ready(function () {
                                tbListCharge = $('#list-data').DataTable({
                                    ...
                                    "sDom": 'R<>rt<ip><"clear">',
                                    "bServerSide": true,
                                    "sAjaxSource": '{!! asset('history-box/list') !!}',
                                    ...
                                    "columns": [
                                        ...
                                        },
                                        {
                                            data: 'gift',
                                            render: function (gift) {
                                                return numeral(gift.price).format('0,0') + ' vnđ';
                                            }
                                        },
                                        {
                                            data: 'value',
