    ...
    <div class="c-layout-page content-dark">
        <div class="c-layout-page">
            ...
            <div class="c-layout-page" style="margin-top: 20px;">
                <div class="container">
                    @include('user.partials.sidebar', ['active' => 13])
                    <div class="c-layout-sidebar-content">
                        <div class="c-content-title-1">
                            <h3 class="c-font-uppercase c-font-bold">Lịch sử quay xèng</h3>
                        ...
                        <script type="text/javascript">
                            ...
                            $(document).ready(function () {
                                tbListCharge = $('#list-data').DataTable({
                                    ...
                                    "sDom": 'R<>rt<ip><"clear">',
                                    "bServerSide": true,
                                    "sAjaxSource": '{!! asset('history-slot-machine/list') !!}',
