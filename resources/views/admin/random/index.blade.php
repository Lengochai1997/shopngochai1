                        ...
                        <div class="col-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Danh sách Random</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <table class="table pb-3" id="list-random">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">Tiêu đề Random</th>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('#list-random').DataTable({
                                                ...
                                                "columnDefs": [
                                                    {
                                                        ...
                                                        "render": function (id, type, full, meta) {
                                                            let baseUrl = '{!! asset('admin/random') !!}';
                                                            let urlEdit = `${baseUrl}/random/${id}/edit`;
                                                            let urlListAccount = `${baseUrl}/list-account/${id}`;
                                                            let urlDelete = `${baseUrl}/random/${id}`;
                                                            return `
                                                                <div class="btn-group">
                                                ...
                                                "bServerSide": true,
                                                "sAjaxSource": '{!! asset('admin/random/list') !!}',
