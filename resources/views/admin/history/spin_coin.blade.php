                    ...
                    <div class="col-sm-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Lịch sử mua vòng quay tiền ảo</h6>
                            </div>
                            <!-- Card Body -->
                            <div class="card-body">
                                ...
                                <script type="text/javascript">
                                    ...
                                    $(document).ready(function () {
                                        tbListCharge = $('#list-bought').DataTable({
                                            ...
                                            "bServerSide": true,
                                            "sAjaxSource": '{!! asset('admin/history/spin-coin?type=json') !!}',
                                            ...
                                            "columns": [
                                                ...
                                                {data:'result'},
                                                {
                                                    data: 'spin',
                                                    render: function (spin) {
                                                        return spin ? numeral(spin).format(0,0) + ' vnđ' : '';
                                                    }
                                                },
                                            ],
                                            "pageLength": 10,
