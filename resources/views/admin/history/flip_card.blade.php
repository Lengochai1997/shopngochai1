                    ...
                    <div class="col-sm-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Lịch sử lật thẻ bài</h6>
                            </div>
                            <!-- Card Body -->
                            <div class="card-body">
                                ...
                                <script type="text/javascript">
                                    ...
                                    $(document).ready(function () {
                                        tbListCharge = $('#list-bought').DataTable({
                                            ...
                                            "bServerSide": true,
                                            "sAjaxSource": '{!! asset('admin/history/flip-card?type=json') !!}',
                                            ...
                                            "columns": [
                                                ...
                                                {
                                                    data: 'flip_card_price', render: function (slot_machine_price) {
