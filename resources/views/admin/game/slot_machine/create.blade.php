                        ...
                        <div class="col-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <form id="create-data" action="{{ asset('admin/slot-machine/slot-machine?model='.$model) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                @method('post')
                                                <input type="hidden" name="model" value="{{ $model }}">
                                                @include('admin.game.slot_machine.partials.entry_'.$model, ['mode' => 'create'])
