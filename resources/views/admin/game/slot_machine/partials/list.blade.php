...
<script type="text/javascript">
    let models = JSON.parse('{!! json_encode(config('slot_machine.model')) !!}')
    $(document).ready(function () {
        $('#list-random').DataTable({
            ...
            "columnDefs": [
                {
                    ...
                    "render": function (id, type, full, meta) {
                        let baseUrl = '{!! asset('admin/slot-machine/slot-machine') !!}';
                        let urlEdit = `${baseUrl}/${id}/edit`;
                        let urlDelete = `${baseUrl}/${id}`;
                        let urlStar = `{!! asset('admin') !!}/star/star?type=slot_machine&type_id=${id}`;
                        return `
                            <div class="btn-group">
            ...
            "bServerSide": true,
            "sAjaxSource": '{!! asset('admin/slot-machine/slot-machine?type=json') !!}',
            ...
            "columns": [
                ...
                {data: 'type'},
                {
                    data: 'model', render: function (model) {
                        return models[model] ? models[model] : 'Thường';
                    }
                },
                {data: 'status'},
            ],
