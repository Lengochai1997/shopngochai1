                        ...
                        <div class="col-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Sửa game Lật thẻ bài</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <form id="create-data" action="{{ asset('admin/flip-card/flip-card/'.$item->id) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                @method('put')
                                                @include('admin.game.flip_card.partials.entry', ['mode' => 'edit'])
