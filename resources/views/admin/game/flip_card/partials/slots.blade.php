<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <small id="image_slotHelp" class="form-text text-muted">Chú ý: Ảnh trong khung này khác với ảnh khung ngoài, chỉ sử thông tin ở khung ngoài. Ngoài ra, ở dưới có mục tỉ lệ, mặc định tổng tỉ lệ là 100, nếu muốn luôn là không trúng thưởng thì set tất cả về 0, còn nếu test để quay video thì set sao cho tổng bằng 100.</small>
        </div>
