                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form id="add-category" action="{{ asset('admin/category/category/'.$item->id) }}" method="post" enctype="multipart/form-data">
                                        @method('put')
                                        @include('admin.category.partials.entry', ['mode' => 'edit'])
