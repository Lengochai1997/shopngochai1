        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#list-random').DataTable({
                    ...
                    "columnDefs": [
                        {
                            ...
                            "render": function (id, type, full, meta) {
                                let baseUrl = '{!! asset('admin/virtual-history-special/virtual-history-special') !!}';
                    ...
                    "bServerSide": true,
                    "sAjaxSource": '{!! asset('admin/virtual-history-special/virtual-history-special?type=json') !!}',
