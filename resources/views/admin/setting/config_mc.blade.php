                        ...
                        <div class="col-6">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Cấu hình Mua card</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form id="form-data" action="{!! asset('admin/setting/config-mc') !!}" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="title">Callback</label>
                                            <input type="text" class="form-control" id="callback" name="callback" placeholder="Callback" value="{{ isset($config->callback) ? $config->callback : '' }}">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    $(document).ready(function () {
                                        $('#form-data').validate({
                                            ...
                                            messages: {
                                                ...
                                                callback: {
                                                    required: 'Callback không được bỏ trống.',
                                                },
                                            },
