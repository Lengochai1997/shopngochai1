                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('#list-accounts').DataTable({
                                                ...
                                                "columnDefs": [
                                                    {
                                                        ...
                                                        "render": function (id, type, full, meta) {
                                                            let baseUrl = '{!! asset('admin/spin/coin') !!}';
                                                            let urlEdit = `${baseUrl}/${id}/edit`;
                                                            let urlDelete = `${baseUrl}/${id}`;
                                                            let urlVirtualHistory= `{!! asset('admin/virtual') !!}/create?type=spin_coin&id=${id}`;
                                                            let urlStar = `{!! asset('admin') !!}/star/star?type=spin_coin&type_id=${id}`;
                                                            return `
                                                                <div class="btn-group">
                                                                    ...
                                                                    <button class="btn btn-outline-primary" data-url="${urlVirtualHistory}" onclick="listStar(this)"><i class="fas fa-history"></i></button>
                                                ...
                                                "bServerSide": true,
                                                "sAjaxSource": '{!! asset('admin/spin/list-coin') !!}',
