                        ...
                        <div class="col-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Thêm vòng quay {{ config('coin.type')[$type] }}</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form id="create-spin" action="{{ asset('admin/spin/coin') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('post')
                                        @include('admin.spin_coin.partials.entry', ['mode' => 'create'])
